...
<body>
  ...
  <div>
    ...
    <h2>DATA SISWA XI RPL</h2>

   <button><a href="datasiswaorm11.php" style="text-decoration: none">INDUSTRI</a></button> 
<table border="2" align="center">
    ...
    include "koneksi.php";
    $no=1;
    $ambil = mysqli_query($koneksi,"select*from vdata1  ");
    while ($tampil = mysqli_fetch_array($ambil)){
      ...
      <td>$no</td>
          ...
          <td><a style=color:black;font-size:20px;text-decoration:none;font-family:Arial; href='editsiswa11.php?kode=$tampil[nisn]'>Ubah</a></td>
...
<?php
            ...
            ?>
<li><button style="margin-top:10;"><a href="inputsiswa11.php" style="text-decoration: none;">TAMBAH DATA</a></button></li>
</body>
</html>
</body>
</html>